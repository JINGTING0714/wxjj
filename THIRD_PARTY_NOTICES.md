...
PRISM includes or builds upon the following open-source projects. Their original license texts are distributed in the corresponding installed packages.

- Geist — Copyright Vercel, SIL Open Font License 1.1.
- Lucide — Copyright Lucide Contributors, ISC License.
- React and React DOM — Copyright Meta Platforms, Inc. and affiliates, MIT License.
- Vite — Copyright VoidZero Inc. and Vite contributors, MIT License.
- Tailwind CSS — Copyright Tailwind Labs, Inc., MIT License.
- Base UI — Copyright MUI, MIT License.
...
No third-party stock photography, remote font file, analytics SDK, advertising SDK, or tracking pixel is included in the application runtime.
